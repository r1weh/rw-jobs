Config.CircleZones = {
	BatuField = {coords = vector3(2946.7392578125,2795.0068359375,40.665550231934), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	WeedField = {coords = vector3(-499.86, 5459.9, 80.13), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	CabeField = {coords = vector3(256.28, 6459.28, 31.42), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	CoklatField = {coords = vector3(-1604.13, 2205.93, 81.35), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	GaramField = {coords = vector3(446.52, 6728.89, 5.3), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	KopiField = {coords = vector3(-1604.13, 2205.93, 81.35), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	PadiField = {coords = vector3(643.03, 6474.95, 74.86), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	TebuField = {coords = vector3(694.12, 6468.17, 30.53), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
	TehField = {coords = vector3(-1604.13, 2205.93, 81.35), name = 'WeedField', color = 25, sprite = 496, radius = 100.0},
}
